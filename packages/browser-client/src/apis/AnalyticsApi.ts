 ...
 */
import type { CostHistoryDto, DashboardAnalyticsDto } from "../models/index";
import {
...
export class AnalyticsApi extends runtime.BaseAPI {
  /**
   */
  async analyticsControllerGetCostHistoryRaw(
    requestParameters: AnalyticsControllerGetCostHistoryRequest,
    initOverrides?: RequestInit | runtime.InitOverrideFunction,
  ): Promise<runtime.ApiResponse<CostHistoryDto>> {
    if (requestParameters.envId === null || requestParameters.envId === undefined) {
      throw new runtime.RequiredError(
        "envId",
        "Required parameter requestParameters.envId was null or undefined when calling analyticsControllerGetCostHistory.",
      );
    }
    ...
    if (requestParameters.dateSelection === null || requestParameters.dateSelection === undefined) {
      throw new runtime.RequiredError(
        "dateSelection",
        "Required parameter requestParameters.dateSelection was null or undefined when calling analyticsControllerGetCostHistory.",
      );
    }
    ...
    const response = await this.request(
      {
        path: `/env/{envId}/analytics/cost-history`.replace(
          `{${"envId"}}`,
  ...
  /**
   */
  async analyticsControllerGetCostHistory(
    requestParameters: AnalyticsControllerGetCostHistoryRequest,
    initOverrides?: RequestInit | runtime.InitOverrideFunction,
...
export type AnalyticsControllerGetCostHistoryDateSelectionEnum =
  (typeof AnalyticsControllerGetCostHistoryDateSelectionEnum)[keyof typeof AnalyticsControllerGetCostHistoryDateSelectionEnum];
/**
 * @export
 */
