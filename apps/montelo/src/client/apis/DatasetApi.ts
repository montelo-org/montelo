 ...
 */
import type { CreateDatasetInput, DatasetDto, DeleteSuccessDto, FullDatasetWithCountDto } from "../models/index";
import {
...
export class DatasetApi extends runtime.BaseAPI {
  /**
   */
  async datasetControllerCreateRaw(
    requestParameters: DatasetControllerCreateRequest,
    ...
    if (requestParameters.createDatasetInput === null || requestParameters.createDatasetInput === undefined) {
      throw new runtime.RequiredError(
        "createDatasetInput",
        "Required parameter requestParameters.createDatasetInput was null or undefined when calling datasetControllerCreate.",
      );
    }
  ...
  /**
   */
  async datasetControllerDeleteRaw(
    requestParameters: DatasetControllerDeleteRequest,
    initOverrides?: RequestInit | runtime.InitOverrideFunction,
  ): Promise<runtime.ApiResponse<DeleteSuccessDto>> {
    if (requestParameters.datasetId === null || requestParameters.datasetId === undefined) {
      throw new runtime.RequiredError(
        "datasetId",
        "Required parameter requestParameters.datasetId was null or undefined when calling datasetControllerDelete.",
      );
    }
    ...
    const response = await this.request(
      {
        path: `/dataset/{datasetId}`.replace(
          `{${"datasetId"}}`,
          encodeURIComponent(String(requestParameters.datasetId)),
        ),
        method: "DELETE",
        headers: headerParameters,
        query: queryParameters,
  ...
  /**
   */
  async datasetControllerGetAllDatasetsRaw(
    initOverrides?: RequestInit | runtime.InitOverrideFunction,
  ): Promise<runtime.ApiResponse<Array<DatasetDto>>> {
    const queryParameters: any = {};
  ...
  /**
   */
  async datasetControllerGetAllDatasets(
    initOverrides?: RequestInit | runtime.InitOverrideFunction,
  ): Promise<Array<DatasetDto>> {
  ...
  /**
   */
  async datasetControllerGetFullDatasetRaw(
    requestParameters: DatasetControllerGetFullDatasetRequest,
    initOverrides?: RequestInit | runtime.InitOverrideFunction,
  ): Promise<runtime.ApiResponse<FullDatasetWithCountDto>> {
    if (requestParameters.datasetId === null || requestParameters.datasetId === undefined) {
      throw new runtime.RequiredError(
        "datasetId",
        "Required parameter requestParameters.datasetId was null or undefined when calling datasetControllerGetFullDataset.",
      );
    }
  ...
  /**
   */
  async datasetControllerGetFullDataset(
    requestParameters: DatasetControllerGetFullDatasetRequest,
    initOverrides?: RequestInit | runtime.InitOverrideFunction,
