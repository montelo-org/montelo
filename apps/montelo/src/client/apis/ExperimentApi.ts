...
export class ExperimentApi extends runtime.BaseAPI {
  /**
   */
  async experimentControllerCreateRaw(
    requestParameters: ExperimentControllerCreateRequest,
    initOverrides?: RequestInit | runtime.InitOverrideFunction,
  ): Promise<runtime.ApiResponse<ExperimentDto>> {
    if (requestParameters.datasetSlug === null || requestParameters.datasetSlug === undefined) {
      throw new runtime.RequiredError(
        "datasetSlug",
        "Required parameter requestParameters.datasetSlug was null or undefined when calling experimentControllerCreate.",
      );
    }
    ...
    if (requestParameters.createExperimentInput === null || requestParameters.createExperimentInput === undefined) {
      throw new runtime.RequiredError(
        "createExperimentInput",
        "Required parameter requestParameters.createExperimentInput was null or undefined when calling experimentControllerCreate.",
      );
    }
    ...
    const response = await this.request(
      {
        path: `/dataset/{datasetSlug}/experiment`.replace(
          `{${"datasetSlug"}}`,
  ...
  /**
   */
  async experimentControllerCreate(
    requestParameters: ExperimentControllerCreateRequest,
    initOverrides?: RequestInit | runtime.InitOverrideFunction,
  ...
  /**
   */
  async experimentControllerGetFullExperimentRaw(
    requestParameters: ExperimentControllerGetFullExperimentRequest,
    initOverrides?: RequestInit | runtime.InitOverrideFunction,
  ): Promise<runtime.ApiResponse<FullExperimentDto>> {
    if (requestParameters.experimentId === null || requestParameters.experimentId === undefined) {
      throw new runtime.RequiredError(
        "experimentId",
        "Required parameter requestParameters.experimentId was null or undefined when calling experimentControllerGetFullExperiment.",
      );
    }
    ...
    const response = await this.request(
      {
        path: `/dataset/experiment/{experimentId}`.replace(
          `{${"experimentId"}}`,
          encodeURIComponent(String(requestParameters.experimentId)),
        ),
        method: "GET",
        headers: headerParameters,
        query: queryParameters,
  ...
  /**
   */
  async experimentControllerGetFullExperiment(
    requestParameters: ExperimentControllerGetFullExperimentRequest,
    initOverrides?: RequestInit | runtime.InitOverrideFunction,
  ): Promise<FullExperimentDto> {
  ...
  /**
   */
  async experimentControllerRunRaw(
    requestParameters: ExperimentControllerRunRequest,
    initOverrides?: RequestInit | runtime.InitOverrideFunction,
  ): Promise<runtime.ApiResponse<EventQueuedDto>> {
    if (requestParameters.createRunInput === null || requestParameters.createRunInput === undefined) {
      throw new runtime.RequiredError(
        "createRunInput",
        "Required parameter requestParameters.createRunInput was null or undefined when calling experimentControllerRun.",
      );
    }
  ...
  /**
   */
  async experimentControllerRun(
    requestParameters: ExperimentControllerRunRequest,
    initOverrides?: RequestInit | runtime.InitOverrideFunction,
  ): Promise<EventQueuedDto> {
